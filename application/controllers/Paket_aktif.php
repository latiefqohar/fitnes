    ...
    public function __construct()
    {
     ...
     public function index()
     {
        if ($this->session->userdata('login') != 1) {
         ...
         $data['paket'] = $this->db->query("select a.*,b.nama as nama_member,c.nama from paket a join member b on a.id_member=b.id join kategori c on a.id_kategori=c.id")->result();
